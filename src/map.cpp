...
void Map::loadMap(string fileName){
    ifstream MyFile("C:/Users/arlot/OneDrive/Documents/C++/3D_Vim/my_project/Maps/" + fileName);
...
void Map::saveMap(string fileName){
    ofstream file("C:/Users/arlot/OneDrive/Documents/C++/3D_Vim/my_project/Maps/" + fileName);
